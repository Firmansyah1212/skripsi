package com.example.firmanskripsi.alg;
...
public class LSB2bit {
    ...
    //variable yang berguna untuk shift index
    ...
    /**
     * Method ini adalah inti dari LSB pada 2 bit terakhir (Encoding).
                ...
                for (int channelIndex = 0; channelIndex < channels; channelIndex++) {
                    if (!msgEnded) {
                        ...
                        tmp = (byte) ((((oneDPix[element] >> binary[channelIndex]) & 0xFF) & 0xFE)
                                | ((msg[msgIndex] >> toShift[(shiftIndex++)% toShift.length]) & 0x1));
